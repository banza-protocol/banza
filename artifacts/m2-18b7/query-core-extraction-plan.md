...
- Rust-first / repo guards: adding a new crate + moving generated indexes may trip ADR-037 rust-rule-check allowlists, the generated-index clean guard, or repo-guards path ranges — update guard config in the same PR.
