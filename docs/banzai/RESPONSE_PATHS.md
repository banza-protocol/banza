...
- **Governing decisions:** [ADR-048](../../decisions/adr/ADR-048-banzai-qwen-first-grounded-routing.md) (Qwen-first routing) · [ADR-051](../../decisions/adr/ADR-051-banzai-per-answer-execution-path-metadata.md) (per-answer metadata) · [ADR-046](../../decisions/adr/ADR-046-banzai-disable-qwen-reasoning-prefix-warmup.md) (reasoning disabled)
