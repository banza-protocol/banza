...
governação da Banzami (D-060-02). Nomear a Banzami como primeiro operador de scheme não faz do BANZA um
...
Outras entidades legalmente habilitadas podem adoptar o protocolo e operar schemes **independentes**
(D-060-04). Forma canónica: *"A Banzami administra o primeiro scheme operacional baseado no BANZA. Outras
...
Scheme** (L3) (D-060-06). O registo técnico não depende do directório do scheme; a verificação pública
...
operadores (D-060-07). O critério de sobrevivência do ADR-001 aplica-se também à relação com o scheme: o
...
— estão em [`BANZA_REGULATORY_CLAIM_POLICY.md`](BANZA_REGULATORY_CLAIM_POLICY.md) (D-060-08).
