...
O Trust Root assina **apenas o Manifesto de Chaves** (o artefacto que endossa as **Delegated Signing Keys**). São as chaves delegadas que assinam os artefactos dos respectivos domínios — metadados do protocolo, releases, evidência de conformidade e a **Revocation List** — nunca a raiz directamente (INV-ROOT-004; ADR-079).
