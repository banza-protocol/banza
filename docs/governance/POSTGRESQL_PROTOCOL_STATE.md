...
- **Estado:** Canónico
- **Data:** 2026-07-19
- **Decisão de referência:** [ADR-026](../../decisions/adr/ADR-026-postgresql-as-protocol-state-store.md)
  (ver também [ADR-008](../../decisions/adr/ADR-008-dedicated-postgresql-and-backups.md))
