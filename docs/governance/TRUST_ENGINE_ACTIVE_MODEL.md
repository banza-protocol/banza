...
**Engine:** `engines/banza-trust` (ADR-038, R5) · WASM em `website/lib/wasm/banza_trust*`
...
A Trust Root assina apenas o Manifesto de Chaves, que endossa as chaves delegadas; são estas que assinam metadata de protocolo, releases e revocation lists (ADR-025). **Não autoriza
