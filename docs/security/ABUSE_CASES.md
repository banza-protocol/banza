...
| AB-BRL-FORGE-07 | external attacker | Forges/re-signs a BRL to un-revoke a peer | issuer MUST be BANZA; revocation-domain key separation (ADR-038); signature verification is a trust-engine concern (M2 root ceremony PLANNED) | protocol | partial |
