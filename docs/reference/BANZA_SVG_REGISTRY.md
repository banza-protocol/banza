...
| SVG-P-008 | Federation Overview | `federation-overview-v1.svg` | `federation.svg` | **CANONICAL** `docs/reference/diagrams/protocol/` | HIGH | docs/reference/en/complete.md §5, ADR-031 | /federation, / |
...
| SVG-P-013 | Trust Hierarchy | `trust-hierarchy-v1.svg` | — | **CANONICAL** `docs/reference/diagrams/protocol/` | HIGH | docs/reference/en/complete.md §6, ADR-027 | /trust, / |
| SVG-P-014 | Root Key Hierarchy | `root-key-hierarchy-v1.svg` | — | **CANONICAL** `docs/reference/diagrams/protocol/` | HIGH | ADR-027 (four-layer hierarchy) | /trust |
| SVG-P-015 | Key Manifest Lifecycle | `key-manifest-lifecycle-v1.svg` | — | **NEW** | MEDIUM | docs/reference/en/complete.md §6, ADR-027 | /trust |
| SVG-P-017 | BRL Lifecycle | `brl-lifecycle-v1.svg` | — | **NEW** | MEDIUM | ADR-027, docs/reference/en/complete.md §6 | /trust, /federation |
| SVG-P-018 | Operator Lifecycle | `operator-lifecycle-v1.svg` | — | **NEW** | MEDIUM | docs/reference/en/complete.md §8, ADR-039 | /operators |
...
| SVG-P-021 | BanzAI Positioning (asset retired; the "authority chain" framing is superseded by ADR-042 — no central authority) | `banzai-authority-chain-v1.svg` | `banzai-positioning-v1.svg` | **RETIRED** (asset absent; not served) | LOW | docs/reference/pt/completa.md §8 | — |
...
- CANONICAL (created, in `docs/reference/diagrams/protocol/`): 8 (SVG-P-001, SVG-P-002, SVG-P-006, SVG-P-008, SVG-P-009, SVG-P-010, SVG-P-013, SVG-P-014) — SVG-P-021 RETIRED (asset absent; "authority chain" superseded by ADR-042)
...
│   ├── banzai-authority-chain-v1.svg        SVG-P-021 (RETIRED — asset absent; superseded by ADR-042)
...
BanzAI SVGs are consolidated into this monorepo (ADR-042) and live at `website/public/diagrams/banzai/` and `docs/reference/diagrams/protocol/banzai-*.svg` — there is no separate BanzAI repository. They must still comply with brand and language standards.
...
Diagramas do modelo de trust aberto (ADR-027 · ADR-033 · ADR-031). A participação de operadores
...
| ~~SVG-P-079~~ | ~~`operador-zero-architecture-v1.svg`~~ | **RETIRADO (M2.19G §29)** | Arquitectura do simulador (ledger fictício, arquitectura do simulador) — ficheiro removido; substituído pelo conjunto v2 SVG-P-088/089 (alvo de validação só de leitura + separação de responsabilidades). ADR-041. |
| ~~SVG-P-080~~ | ~~`operador-zero-e2e-journey-v1.svg`~~ | **RETIRADO (M2.19G §29)** | Jornada E2E de seis passos com score 100/100 — ficheiro removido; substituído por SVG-P-090 (jornada de validação de nove passos, sem score). ADR-041. |
| ~~SVG-P-081~~ | ~~`operador-zero-negative-flow-v1.svg`~~ | **RETIRADO (M2.19G §29)** | Fluxo negativo auto-executado — ficheiro removido; a referência só de leitura não executa simulação (ADR-041). |
| ~~SVG-P-082~~ | ~~`operador-zero-ledger-kzdemo-v1.svg`~~ | **RETIRADO (M2.19G §29)** | Ledger fictício KZ_DEMO — ficheiro removido; a referência só de leitura não corre ledger mutável (ADR-041). |
...
ao modelo activo M2.19 (ADR-003..067): três camadas **Camada 1 Protocolo aberto · Camada 2 Certificação de Conformidade e
...
fechada (ADR-035); e a separação **certificação técnica ≠ admissão a esquema ≠ autorização regulatória**
(ADR-004). Nenhum diagrama apresenta conceitos retirados: autoridade central de emissão, credencial por
...
## M2.19G.1 §35 — Validação originada nos endpoints (ADR-038)
...
- **`banzai-single-answer-pipeline.svg` (SVG-P-087)** — o embed foi removido de `BANZA_REFERENCIA.md` §12
  ...
  segundo validador obrigatório (validador de pós-resposta, ADR-042) ao tronco explicativo. A prosa de §12
