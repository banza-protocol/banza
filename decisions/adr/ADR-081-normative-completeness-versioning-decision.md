# ADR-081 — Versioning Decision for the Normative-Completeness Remediation
...
broken. This is the decisive argument, and it is the frame the remediation milestone itself proposed:
...
This ADR decides versioning only. It does not choose the canonicalization algorithm — that is ADR-082 —
