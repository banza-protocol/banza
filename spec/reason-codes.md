...
- **Authority:** [ADR-083](../decisions/adr/ADR-083-reason-code-model.md)
...
The asymmetry is deliberate. Adding a core reason code is a backward-compatible change under ADR-081's
...
- Adding a core code is **backward compatible** and does not change `protocol_version` (ADR-081).
