...
**Authority:** FEDERATION_PROTOCOL_FLOW.md, ADR-025, ADR-031, ADR-025
...
The ten conjunctive, fail-closed checks of ADR-025, run by Op-A locally over Op-B's self-published
