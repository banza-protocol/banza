...
**Authority:** ADR-038, ADR-039, ADR-040; `docs/governance/FEDERATION_TRUST_MODEL.md`
...
the **Open Trust Evaluation** — ten conjunctive, fail-closed checks (ADR-040) — over that peer's
...
1. ADR-038, ADR-039, ADR-040 (open trust model, self-publication, Open Trust Evaluation)
...
**The prerequisite that makes everything else possible:** the trust model itself (ADR-038, ADR-039,
ADR-040). Without it, manifests cannot be signed, published evidence cannot be verified, and peers
