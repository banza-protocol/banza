...
**Authority:** `FEDERATION_CONFORMANCE_PATH.md`, `docs/governance/FEDERATION_TRUST_MODEL.md`, ADR-025, ADR-031, ADR-025
...
1. Verify the `Banza-Federation-Signature` header (ed25519 — see ADR-025)
2. Run the Open Trust Evaluation (ten checks, ADR-025) over the sender's published material at its `protocol_metadata_url`
...
| `decisions/adr/ADR-025*.md`, `ADR-031*.md`, `ADR-025*.md` | Open trust model, self-publication, and the Open Trust Evaluation |
