...
**Authority:** ADR-038, ADR-039, ADR-040; `FEDERATION_CONFORMANCE_MODEL.md`
...
own responsibility (ADR-039 §5), and where financial-services authorisation is required it is granted
