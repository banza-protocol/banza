...
| INV-R01 | Environment isolation (routing) | Sub-invariant (environment isolation; see ADR-030) |
...
> invariants (`INV-OTE-*` / `INV-FEDEVAL-*`, `INV-ROOT-*`) in `docs/reference/en/complete.md` and ADR-038.
