...
See [ADR-014](../decisions/adr/ADR-014-account-and-participant-identity.md) and [ADR-001](../decisions/adr/ADR-001-open-financial-protocol-what-banza-is-and-is-not.md) for the full architectural constraint.
...
(ADR-036) — it is not an authority, not a normative source and not a fourth layer.
