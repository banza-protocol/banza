...
- ADR-017 — Wallet-native merchant payments and refund source model (Accepted).
...
and the open federation trust model (ADR-038, ADR-039, ADR-040). Governed by the ADRs
in `decisions/adr/`.
