// Service facade for the durable validation receipt store (ADR-036).
//
...
// Persistence-status vocabulary (ADR-036 correction 1) — an execution is only "durably concluded" when
...
// ADR-036 read-only telemetry: journey/per-step duration metrics over persisted executions. FAIL-SAFE for
