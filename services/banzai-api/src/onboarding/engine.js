// Onboarding decision engine wrapper (M2.19G.3, ADR-069). RUST_DECIDES.
//
...
// M2.19G.3A — the CLOSED Technical Registry resolver (same vendored WASM the ADR-068 validator uses).
