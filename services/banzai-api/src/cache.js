...
// contractVersion, postValidationPolicy (ADR-073: a policy/contract bump evicts stale-policy
...
export class SemanticCache extends LruStore {
  ...
  // hits exactly like exact ones) AND on the post-validation policy + contract version (ADR-073) AND
