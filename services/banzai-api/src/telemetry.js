// ADR-036 — read-only operational TELEMETRY tool. Given the Rust-decided OperationalDecision
...
// ONLY from SQL aggregates over the durable receipt store (ADR-036); NO model ever produces or edits a
...
// topic list.
//
// Claim taxonomy (ADR-036), applied DETERMINISTICALLY here (no model in the loop):
...
// The structured claims (each bound to its category) — the ADR-036 taxonomy, deterministic.
