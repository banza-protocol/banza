...
|---|---|---|---|
| M2.18B.6 grounded-synthesis dataset (12 categories) | 709 | base, variation, negative, comparison→regression | `services/banzai-api/eval/m2-18b6-grounded.dataset.json (total)` |
...
| M2.18B.2 action-boundary dataset (boundary + informational) | 165 | negative | `services/banzai-api/eval/m2-18b2-boundary.dataset.json (boundary_cases + informational_cases)` |
...
|---|---|---|
| base | 46 | base semantic cases — one canonical human-authored phrasing per meaning |
| variation | 643 | generated lexical variations — capitalization/punctuation/accent/whitespace + paraphrases of the base seeds (a capitalization/punctuation change is a VARIATION, never a new semantic case) |
