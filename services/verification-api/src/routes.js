...
const NOTE =
  ...
  "no funds, balances, real payment transactions or private keys (ADR-013).";
...
// list: listing grants nothing, absence forbids nothing (ADR-025). Empty in
// pre-production. Returns a bare JSON array (ADR-029 / annex §12).
