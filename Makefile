...
## banzai-endpoint-readiness-check: M2.19G.1 — CAPSTONE aggregate gate over the §44 metrics (manual/url/fixture inputs, duplicate/orphan/non-actionable tabs, receipt origin fields, OZ bypasses, qwen/TS verdicts — all 0) (ADR-038 §44)
