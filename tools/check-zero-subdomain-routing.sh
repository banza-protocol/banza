#!/usr/bin/env bash
#
# zero.banza.network — host-aware routing guard (ADR-035, M2.12E).
#
...
STANDALONE_PAGE="website/app/(pt)/oz/page.tsx"
LAB_HANDLER="website/app/(pt)/oz/[...artifact]/route.ts"
...
# Route segments may be multi-part and dotted (ADR-029: .well-known/banza/operator), so the class
