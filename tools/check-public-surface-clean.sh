...
# M2.19 reconciliation (ADR-059/061): Layer 2 is the "BANZA Conformance & Interoperability Certification"
...
# M2.19E/F (ADR-067): the read-only Operador Zero surface + BanzAI Validation Workbench legitimately
...
LABELS=(
  ...
  # M2.19G (ADR-064): bare "certificação" is now CURRENT canonical vocabulary — the per-implementation
...
# MUST allow — M2.19 Layer-2 canonical vocabulary (ADR-059/061): certification of an IMPLEMENTATION.
