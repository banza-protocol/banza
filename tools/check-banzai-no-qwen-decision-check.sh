#!/usr/bin/env bash
#
# M2.19G.1 (ADR-068 §4.8 / Consequences) — no Qwen decision guard (§37, invariant 23).
#
...
echo "== banzai-no-qwen-decision-check (M2.19G.1 / ADR-068 §4.8) =="
...
echo "banzai-no-qwen-decision-check: ✓ Rust decides; Qwen only explains; 0 model calls in receipts (ADR-068 §4.8)"
