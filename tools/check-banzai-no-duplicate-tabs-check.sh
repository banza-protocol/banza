#!/usr/bin/env bash
#
# M2.19G.1 (ADR-034 §29) — no duplicate navigation tabs guard (§37, invariant 12).
#
...
echo "== banzai-no-duplicate-tabs-check (M2.19G.1 / ADR-034 §29) =="
...
echo "banzai-no-duplicate-tabs-check: ✓ no step duplicated as a persistent tab (ADR-034 §29)"
