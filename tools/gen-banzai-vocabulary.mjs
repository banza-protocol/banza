...
const CONCEPT_SUBJECTS = [
  ...
  { id: "banza", name: "BANZA", type: "entity", resolution: "entity coverage (coverage.rs) + attribute terminal + trunk", deliverables: [], aliases: ["banza"], source_ids: ["ADR-001", "ADR-001"], source_paths: ["decisions/adr/ADR-001-open-financial-protocol-what-banza-is-and-is-not.md"] },
  { id: "banzai", name: "BanzAI", type: "entity", resolution: "entity coverage + trunk", deliverables: [], aliases: ["banzai"], source_ids: ["ADR-036", "ADR-036"], source_paths: ["decisions/adr/ADR-036-banzai-a-non-authoritative-interface-to-the-protocol.md"] },
  { id: "banzami", name: "Banzami", type: "entity", resolution: "entity coverage + attribution (GOVERNANCE)", deliverables: [], aliases: ["banzami"], source_ids: ["ADR-001", "GOVERNANCE"], source_paths: ["GOVERNANCE.md"] },
  ...
  { id: "ledger", name: "ledger / dupla entrada", type: "concept", resolution: "trunk synthesis grounded in ADR-012 (double-entry ledger + monetary precision)", deliverables: [], aliases: ["ledger", "dupla entrada", "double entry", "double-entry", "partida dobrada", "posting"], source_ids: ["ADR-012"], source_paths: ["decisions/adr/ADR-012-double-entry-ledger-and-monetary-precision.md"] },
  { id: "wallet", name: "wallet / conta", type: "concept", resolution: "trunk synthesis grounded in ADR-014 (wallet-native identity) / account model", deliverables: [], aliases: ["wallet", "carteira", "conta", "account", "saldo", "balance"], source_ids: ["ADR-014"], source_paths: ["decisions/adr/ADR-014-account-and-participant-identity.md"] },
  { id: "liquidacao", name: "liquidação", type: "concept", resolution: "trunk synthesis grounded in the settlement invariants (INV-SETTLE)", deliverables: [], aliases: ["liquidacao", "settlement", "reconciliacao", "reconciliation"], source_ids: ["ADR-012"], source_paths: ["decisions/adr/ADR-012-double-entry-ledger-and-monetary-precision.md"] },
  { id: "qr", name: "QR / payment session", type: "artefact", resolution: "trunk synthesis grounded in ADR-015 (QR payment system) / ADR-015 (payment session)", deliverables: [], aliases: ["qr", "qr code", "codigo qr", "payment session", "sessao de pagamento", "pagamento"], source_ids: ["ADR-015"], source_paths: ["decisions/adr/ADR-015-qr-payments.md"] },
...
const DOC_SAMPLE = ["ADR-001", "ADR-001", "ADR-025", "RFC-0006"]; // representative current docs for the matrix
