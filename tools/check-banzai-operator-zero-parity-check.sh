#!/usr/bin/env bash
#
# M2.19G.1 (ADR-034 §4.9) — Operador Zero parity guard (§37, invariant 17).
#
...
echo "== banzai-operator-zero-parity-check (M2.19G.1 / ADR-034 §4.9) =="
...
echo "banzai-operator-zero-parity-check: ✓ OZ uses the same registry/endpoint/engine path (ADR-034 §4.9)"
