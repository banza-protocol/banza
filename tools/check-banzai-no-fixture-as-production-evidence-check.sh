#!/usr/bin/env bash
#
# M2.19G.1 (ADR-034 core rule / §4.5) — no fixture as production evidence guard (§37, invariant 20).
#
...
echo "== banzai-no-fixture-as-production-evidence-check (M2.19G.1 / ADR-034 §4.5) =="
...
echo "banzai-no-fixture-as-production-evidence-check: ✓ no fixture flows into official evidence/VERIFIED (ADR-034 §4.5)"
