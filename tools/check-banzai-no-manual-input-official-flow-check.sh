#!/usr/bin/env bash
#
# M2.19G.1 (ADR-034 core rule / §4.4/§4.5) — no manual input in the official flow (§37, invariant 4).
#
...
echo "== banzai-no-manual-input-official-flow-check (M2.19G.1 / ADR-034 §4.4/§4.5) =="
...
echo "banzai-no-manual-input-official-flow-check: ✓ official flow has no textarea/upload/drag-drop/URL/fixture input (ADR-034 §4.4)"
