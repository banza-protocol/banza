#!/usr/bin/env bash
#
# M2.19G.1 (ADR-068 §4.4/§4.7) — no arbitrary URL guard (§37, invariant 7).
#
...
echo "== banzai-no-arbitrary-url-check (M2.19G.1 / ADR-068 §4.4/§4.7) =="
...
echo "banzai-no-arbitrary-url-check: ✓ no user-supplied URL; registry-resolved origin+path only (ADR-068 §4.7)"
