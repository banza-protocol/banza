...
add('spec/root-authority-set.md', 'NORMATIVE_SPECIFICATION', IMPL,
    'Who may exercise Root authority, and how a successor set is authorised by the threshold of the set '
    'it succeeds. The genesis set is pinned; a self-signed set authorises nothing.')
add('contracts/production/root-authority-set.production.schema.json', 'NORMATIVE_CONTRACT', IMPL,
    'The Root Authority Set wire shape: three authorities, threshold two, predecessor digest and '
    'predecessor signatures.')
add('conformance/vectors/root-authority-set.json', 'NORMATIVE_VECTORS', CONF,
    'Genesis pinning, predecessor authorisation, threshold arithmetic and the self-signed rejection.')
