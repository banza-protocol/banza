#!/usr/bin/env bash
# banzai-primary-interface-architecture-check (M2.14I · ADR-036).
#
...
echo "== banzai-primary-interface-architecture-check (M2.14I · ADR-036) =="

# ─────────────────────────────────────────────────────────────────────────────────────────────
# A. ADR (the architecture decision).
# ─────────────────────────────────────────────────────────────────────────────────────────────
echo "-- A. ADR --"
[ -f "$ADR" ] && ok "ADR-036 exists" || fail "ADR-036 must exist ($ADR)"
