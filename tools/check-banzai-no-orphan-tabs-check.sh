#!/usr/bin/env bash
#
# M2.19G.1 (ADR-068 §29) — no orphan tabs guard (§37, invariant 13).
#
...
echo "== banzai-no-orphan-tabs-check (M2.19G.1 / ADR-068 §29) =="
...
echo "banzai-no-orphan-tabs-check: ✓ every renderable panel is in the sidebar; no orphans (ADR-068 §29)"
