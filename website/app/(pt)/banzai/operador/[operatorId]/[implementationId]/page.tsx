...
export const metadata: Metadata = {
  ...
  description:
    "Contexto de implementação do BanzAI: percorra a jornada determinística de 9 etapas de validação técnica sobre a implementação selecionada. Validação endpoint-originada (ADR-034); o BanzAI não certifica nem aprova.",
