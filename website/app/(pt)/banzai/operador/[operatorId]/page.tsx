...
export const metadata: Metadata = {
  ...
  description:
    "Contexto de operador do BanzAI: selecione uma implementação publicada e valide-a tecnicamente. A validação é endpoint-originada (ADR-034) e o BanzAI não certifica nem aprova operadores.",
