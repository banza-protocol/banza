...
// /banzai/operador/[operatorId] — M2.19G.4 (ADR-070). The OPERATOR context of the single BanzAI interface.
...
// ever fetched from a segment (ADR-068 §4.6/§4.7).

export const metadata: Metadata = {
  title: "BanzAI — Operador",
  description:
    "Contexto de operador do BanzAI: selecione uma implementação publicada e valide-a tecnicamente. A validação é endpoint-originada (ADR-068) e o BanzAI não certifica nem aprova operadores.",
...
export default async function OperatorContextPage({
  ...
  // context segment → honest notFound(), never treated as an operator (ADR-070 D-070-03; ADR-068 safety).
