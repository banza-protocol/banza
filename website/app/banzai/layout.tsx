// /banzai layout — M2.19G.4 (ADR-070). Mounts the single, always-mounted BanzAI workspace ONCE around
...
//
// /banzai remains the SINGLE human-operator interface (ADR-054, ADR-067): one shell, one session. The
...
// ADR-076 D-076-10 — the app /banzai surface derives its runtime/provider state from the runtime SSOT
