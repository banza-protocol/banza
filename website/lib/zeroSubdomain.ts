// Host-aware routing for the Operador Zero dedicated subdomain (ADR-052, M2.12E/F/G).
//
...
export const ZERO_ENDPOINTS = [
  ".well-known/banza/operator",             // ADR-080: canonical discovery manifest (was /manifest.json)
  "key-manifest",
  "revocation-list",
  ...
  "discovery",
  "capabilities",
  ".well-known/banza/signed-protocol-metadata", // ADR-080: canonical signed metadata (was /signed-metadata.json)
  "federation-metadata",
] as const;
