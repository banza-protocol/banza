// BanzAI operator-guidance adapter (ADR-049; reframed by ADR-076 §D-076-01/02). RUST_WRAPPER_ONLY.
//
 ...
 *  score (ADR-076 §D-076-02). There is no positive-technical status here by construction. */
