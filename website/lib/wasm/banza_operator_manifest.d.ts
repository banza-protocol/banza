...
export interface InitOutput {
    ...
    readonly operator_manifest_validate_json: (a: number, b: number) => [number, number];
    readonly operator_manifest_demo_fixtures_json: () => [number, number];
    readonly operator_manifest_schema_json: () => [number, number];
    readonly operator_manifest_tool_version_json: () => [number, number];
