/* @ts-self-types="./operator_zero_core.d.ts" */
 ...
 * @returns {string}
 */
export function operator_zero_boundary_json(artifacts_json) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(artifacts_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.operator_zero_boundary_json(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
 ...
 * @returns {string}
 */
export function operator_zero_e2e_json(happy) {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.operator_zero_e2e_json(happy);
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {string}
 */
export function operator_zero_identity_json() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.operator_zero_identity_json();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {string}
 */
export function operator_zero_label(slug) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(slug, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.operator_zero_label(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {string}
 */
export function operator_zero_ledger_json() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.operator_zero_ledger_json();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {string}
 */
export function operator_zero_safe_summary(trace_json) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(trace_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.operator_zero_safe_summary(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {string}
 */
export function operator_zero_vocabulary_json() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.operator_zero_vocabulary_json();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./operator_zero_core_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('operator_zero_core_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
