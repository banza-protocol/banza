...
export const ROUTES: readonly RouteRecord[] = Object.freeze([
  ...
  },
  {
    ...
    kind: "STATIC_PAGE",
    policy: "BILINGUAL",
    note: "EN counterpart is /en/reference — English URLs in English, not /en/referencia. Route not yet built.",
  },
  {
    ...
    note: "Owns the FAQ / certification / governance / developers content the four aliases point at. EN counterpart is /en/reference/[chapter] with English slugs; chapterCounterpart() maps them through the semantic chapter number, never by prefixing. Route not yet built.",
  },
  {
    id: "REFERENCE_FULL",
    ...
    kind: "STATIC_PAGE",
    policy: "BILINGUAL",
    note: "EN counterpart is /en/reference/full. Route not yet built.",
  },
  {
