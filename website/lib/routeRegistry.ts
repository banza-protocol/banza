...
export const ROUTES: readonly RouteRecord[] = Object.freeze([
  ...
  { id: "REFERENCE", pt: "/referencia", kind: "STATIC_PAGE", policy: "BILINGUAL" },
  {
    ...
    note: "Owns the FAQ / certification / governance / developers content the four aliases point at.",
  },
  { id: "REFERENCE_FULL", pt: "/referencia/completa", kind: "STATIC_PAGE", policy: "BILINGUAL" },
  {
