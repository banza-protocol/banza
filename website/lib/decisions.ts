...
export const decisions: Decision[] = [
  ...
  },
  {
    ...
    "category": "Execução e primitivas financeiras",
    "summary": "The BANZA Trust Root is the anchor every conforming implementation pins and uses to verify all subsequent protocol material. Whatever controls it controls the maximum authority in the protocol, so the question \"how many parties must act for"
  },
  {
    "type": "ADR",
    "id": "ADR-027",
  ...
  },
  {
    ...
    "status": "activo",
    "path": "decisions/adr/ADR-040-r2s2-fundamental-principles.md",
    "canonicalUrl": "https://github.com/banza-protocol/banza/blob/main/decisions/adr/ADR-040-r2s2-fundamental-principles.md",
    "category": "Governação e evolução",
  ...
  },
  {
    ...
    "status": "activo",
    "path": "decisions/adr/ADR-041-layered-assurance-gates.md",
    "canonicalUrl": "https://github.com/banza-protocol/banza/blob/main/decisions/adr/ADR-041-layered-assurance-gates.md",
    "category": "Governação e evolução",
    "summary": "No layer may validate itself. Every critical property must be demonstrated through a falsifiable chain of evidence, and a higher gate never compensates for a lower one."
  },
  {
    "type": "RFC",
    "id": "RFC-0001",
    ...
    "summary": "Define how payment routing decisions are made when the Banza ecosystem contains multiple independent operators, each with different rail access and geographic coverage."
  },
  {
    "type": "RFC",
    "id": "RFC-0002",
    ...
    "category": "Propostas técnicas",
    "summary": "Define how settlement is handled when a payment crosses operator boundaries — specifically, how two independent Banza operators net and settle obligations between each other without a central counterparty."
  },
  {
    "type": "RFC",
    "id": "RFC-0003",
    ...
    "category": "Propostas técnicas",
    "summary": "Define a capability flag model for wallets so that operators can declare which wallet features they support without the protocol core assuming all wallets support all flows."
  },
  {
    "type": "RFC",
    "id": "RFC-0004",
    ...
    "category": "Propostas técnicas",
    "summary": "Define a protocol by which Banza operators declare their provider capabilities at startup and how the protocol core uses those declarations to enable graceful degradation and optional feature flows."
  },
  {
    "type": "RFC",
    "id": "RFC-0005",
    ...
    "category": "Propostas técnicas",
    "summary": "Define a future mechanism by which Banza operators announce their capabilities to the ecosystem, enabling routing, interoperability, and multi-operator coordination without a central registry."
  },
  {
    "type": "RFC",
    "id": "RFC-0006",
