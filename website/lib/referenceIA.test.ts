...
describe("Reference chapter order (M2.7L)", () => {
  ...
  it("the Operador Zero chapter carries its boundary and claims nothing", () => {
    ...
    // The institutional comparison belongs to ADR-035 alone (M2.12A decision).
...
describe("Chapter 10 — Federação (final revision)", () => {
  ...
  // Federation is a bounded, local, per-interaction technical RELATION (ADR-025): the result vocabulary
