...
describe("M2.7H — reference presents BanzAI as the protocol agent", () => {
  ...
  // M2.19G.5F — §12 is the canonical 7-section rewrite (ADR-071/ADR-055/ADR-073). These assertions track
  ...
  it("states the canonical single-synthesis architecture (§12 'Como o BanzAI responde', ADR-071/ADR-055)", () => {
