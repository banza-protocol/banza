# ADR-030 — Environment Isolation: Sandbox vs Production
...
**Protocol core-level environment enforcement:** Rejected. Would require the protocol core to know about operator deployment topology, violating the protocol core/operator separation (ADR-003).
