# ADR-044 — Licence, notice, trademark and open governance

- **Status:** Accepted
- **Date:** 2026-07
- **See also:** ADR-001, ADR-002, ADR-001, ADR-001, ADR-042, `LICENSE`, `NOTICE`, `TRADEMARKS.md`, `GOVERNANCE.md`, `MAINTAINERS.md`, `CONTRIBUTING.md`, `docs/governance/licensing.md`
