//! operator-zero-e2e-root (ADR-035, M2.13A) — a DEMO-ONLY Ed25519 signing root for the Operador Zero
...
//!
//! Rust is the source of truth (ADR-038): signing, verification, canonicalisation, fingerprinting and
