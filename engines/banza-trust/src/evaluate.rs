...
/// .production.schema.json, ADR-040). `evaluate_federation_ote` runs all ten fail-closed and emits the
...
/// Full federation Open Trust Evaluation (ADR-040): the ten conjunctive, fail-closed checks producing the
