//! banzai-api-kb (ADR-037, R6) — the Rust retrieval engine for the live banzai-api.
//!
...
// M2.14I (ADR-054) — the primary human-operator interface router: telemetry classification of a
