...
pub const SYSTEM_PROMPT: &str = concat!(
    ...
    "4. Responde na LÍNGUA PEDIDA pelo pedido (nunca a infiras do texto da pergunta) como agente prático: curto se é simples; em pedidos operacionais dá passos/checklist e sugere o próximo passo, citando fontes. Se as <FONTES> tiverem exemplo/esquema, inclui um exemplo curto (JSON/YAML) marcado ILUSTRATIVO e NÃO-NORMATIVO (domínio operator.example); um exemplo não certifica, não serve para produção nem substitui a conformance suite.\n",
