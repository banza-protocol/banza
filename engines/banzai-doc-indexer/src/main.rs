//! banzai-doc-indexer (ADR-036, M2.9A) — build-time Rust indexer for the BANZA protocol documentation.
//!
...
fn chunk_has_forbidden_brand(text: &str) -> bool {
    ...
    [
        ...
        // Layer-3 scheme (ADR-004/060) and MUST be groundable so BanzAI can explain the three-layer
