//! Per-fetch identifiers, timestamps, hashing and the one-line audit record (ADR-068 §4.8, §20).
...
/// Emit exactly one JSON audit line per fetch to stdout (ADR-068 §4.8: protocol fetches are counted
