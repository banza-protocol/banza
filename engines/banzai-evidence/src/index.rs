//! Static local evidence index (ADR-043, R2 · PART 4).
//!
...
pub fn route_sources() -> Vec<EvidenceSource> {
    ...
    vec![
        ...
        adr("adr-001", 1, "ADR-001 — Protocol/Operator Separation", &["adr-001", "separacao", "operador"],
        ...
        adr("adr-041", 41, "ADR-041 — Operador Zero (operador de referência)", &["adr-041", "operador de referencia", "operador zero"],
        ...
        adr("adr-031", 31, "ADR-031 — Federation Trust Evaluation", &["adr-031", "federacao", "confianca"],
        ...
        adr("adr-027", 27, "ADR-027 — Open Protocol Trust Model (raiz de produção)", &["adr-027", "raiz", "chave raiz"],
        ...
        adr("adr-028", 28, "ADR-028 — Root authorization: three authorities, threshold two", &["adr-028", "raiz", "limiar", "2-de-3", "custodia"],
            "A Trust Root do BANZA é controlada por três autoridades de assinatura independentes; qualquer acção autorizada da raiz exige duas assinaturas de duas delas. Uma assinatura isolada nunca autoriza, e duas assinaturas da mesma autoridade contam como uma. O limiar é criptográfico: o número de dispositivos é um controlo de custódia e não o define."),
        adr("adr-029", 29, "ADR-029 — Private keys off serving infrastructure", &["adr-029", "chaves privadas", "secrets"],
        ...
        adr("adr-032", 32, "ADR-032 — KYC operator policy; Trust Assertions federate", &["adr-032", "kyc", "trust assertion"],
