...
pub fn route_sources() -> Vec<EvidenceSource> {
    ...
    vec![
        ...
        adr("adr-003", 3, "ADR-001 — Protocol/Operator Separation", &["adr-003", "separacao", "operador"],
        ...
        adr("adr-052", 52, "ADR-041 — Operador Zero (operador de referência)", &["adr-052", "operador de referencia", "operador zero"],
        ...
        adr("adr-040", 40, "ADR-031 — Federation Trust Evaluation", &["adr-040", "federacao", "confianca"],
        ...
        adr("adr-038", 38, "ADR-027 — Open Protocol Trust Model (raiz de produção)", &["adr-038", "raiz", "chave raiz"],
        ...
        adr("adr-028", 28, "ADR-029 — Private keys off serving infrastructure", &["adr-028", "chaves privadas", "secrets"],
        ...
        adr("adr-029", 29, "ADR-032 — KYC operator policy; Trust Assertions federate", &["adr-029", "kyc", "trust assertion"],
