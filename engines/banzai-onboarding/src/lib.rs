//! banzai-onboarding (M2.19G.3, ADR-069) — the pure Rust security-decision engine for BanzAI-hosted
//! operator onboarding.
//!
...
//! BanzAI service, never a BANZA protocol rule (ADR-069): third parties need none of this to implement
...
/// The minimal candidate lifecycle (ADR-069 §17). A candidate is NEVER a published operator,
