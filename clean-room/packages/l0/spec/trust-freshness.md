...
proofs, audited across observers. BANZA 1.0.0 does not define one, and this specification states the
limit rather than pointing outside itself for it: an implementer must be able to read what is and is not
guaranteed without leaving the normative surface.
