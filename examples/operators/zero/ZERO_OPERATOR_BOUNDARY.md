...
| A superfície é só de leitura: não corre simulação nem tem ledger mutável | ADR-035; a copy nunca diz outra coisa |
| Uma validação é evidência técnica local | ADR-035; a copy nunca diz outra coisa |
...
> [ADR-035](../../../decisions/adr/ADR-035-operator-zero-the-read-only-reference-implementation.md).
...
**substituído pelo ADR-035**. A comparação institucional, com os nomes, vive apenas no ADR-035, por
