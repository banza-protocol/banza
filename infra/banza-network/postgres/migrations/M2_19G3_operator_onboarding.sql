-- M2.19G.3 (ADR-069) — operator onboarding tables (private candidate registry, email-OTP challenges,
...
-- email (ADR-042 boundary; postgres-data-boundary-check). Onboarding is a hosted service, not a
-- protocol rule (ADR-069).
