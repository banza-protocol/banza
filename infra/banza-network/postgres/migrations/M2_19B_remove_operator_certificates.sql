-- M2.19B — Trust/Security/Contracts realignment (Finding B, ADR-058).
...
-- no certificates issued, no BRL entries). Under the open trust model (ADR-038) BANZA
...
-- 3. BANZA issues no operator certificates (ADR-038): drop the issuance table + its grants.
